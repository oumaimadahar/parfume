...
const HairPerfumes = () => {
    ...
    const titles = ["Hair Elegance", "Fragrant Brilliance", "Timeless Shine"];
        ...
        const fetchProducts = async () => {
            try {
                ...
                const manProducts = res.data.products.filter(
                    p => p.category === "HairPerfumes" && !p.isNew
                );
    ...
    return (
        <div>
            ...
            <section
                ...
                style={{ backgroundImage: "url('/images/backgroundHairParfum1.jpg')" }}
            >
