...
const GiftSets = () => {
    ...
    const titles = ["Perfect Gifts", "Timeless Elegance", "Moments of Luxury"];
    ...
    return (
        <div>
            ...
            <section
                ...
                style={{ backgroundImage: "url('/images/background GiftSets.jpg')" }}
            >
                ...
                >
                    ...
                    <motion.p className="text-lg md:text-xl mb-6 max-w-2xl mx-auto text-gray-200">
                        Discover our exclusive Gift Sets — the perfect harmony of elegance and emotion,
                        offering luxurious fragrances designed to make every occasion unforgettable.
                    </motion.p>
                    <motion.button
