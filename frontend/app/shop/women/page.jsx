...
const Women = () => {
    ...
    const titles = ["Feminine Essence", "Elegance & Grace", "Timeless Luxury"];
    ...
    setLikedProducts(prev => {
        ...
        // 🔹 différer la mise à jour globale pour NavBar
        setTimeout(() => {
    ...
    return (
        <div>
            ...
            <section
                ...
                style={{ backgroundImage: "url('/images/backgroundShop.jpg')" }}
            >
                ...
                >
                    ...
                    <motion.p className="text-lg md:text-xl mb-6 max-w-2xl mx-auto text-gray-200">
                        Discover our exclusive women’s fragrance collection — where elegance,
                        grace, and timeless luxury blend into every delicate note.
                    </motion.p>
                    <motion.button
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        onClick={() => {
                            document.getElementById("womenProducts").scrollIntoView({ behavior: "smooth" });
                        }}
            ...
            {/* Section Produits */}
            <section id="womenProducts" className="py-16 px-6 md:px-16">
