...
const Bakhoor = () => {
    ...
    const titles = ["Oriental Essence", "Luxury Aroma", "Timeless Tradition"];
    ...
    return (
        <div>
            ...
            <section
                ...
                style={{ backgroundImage: "url('/images/backgroundBakhoor.jpg')" }}
            >
                ...
                >
                    ...
                    <motion.p className="text-lg md:text-xl mb-6 max-w-2xl mx-auto text-gray-200">
                        Discover our exclusive Bakhoor collection — where tradition,
                        luxury, and captivating aromas blend to create an unforgettable experience.
                    </motion.p>
                    <motion.button
