...
export default function SearchPage() {
    ...
    const query = searchParams.get("q") || ""; // Récupère le mot recherché
    ...
    useEffect(() => {
        ...
        const fetchProducts = async () => {
            try {
                setLoading(true);
                const res = await axios.get("http://localhost:7007/api/products"); // 🔹 Récupère tous les produits
                const allProducts = res.data.products || [];

                // 🔍 Filtrer les produits côté frontend (par nom ou description)
