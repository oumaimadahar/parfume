      ...
      <div className="bg-white shadow-xl rounded-2xl p-8 max-w-2xl w-full">
        ...
        <form onSubmit={handleUpdate} className="space-y-4">
          ...
          <div className="flex gap-3 mt-4">
            ...
            <button type="button" onClick={() => router.push("/admin/dashboard")} className="flex items-center justify-center gap-2 flex-1 bg-gray-400 text-white py-3 rounded-lg font-semibold hover:bg-gray-500 transition">
              <X size={20} /> Cancel
            </button>
          </div>
        </form>
